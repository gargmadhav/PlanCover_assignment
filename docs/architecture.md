...
- **`docs/`**: Contains architectural documentation (outside frontend and backend).
- **`outputs/`**: Dedicated directory for persisted QMS JSON extractions and evaluation outputs (outside frontend and backend).
