...
from backend.app.services.policy_service import policy_service, OUTPUT_DIR
from backend.app.utils.json_utils import dumps_json
from backend.app.utils.logging import logger

SAMPLE_PDF_DIR = os.path.join(root_dir, "technical assessment", "technical assessment")
