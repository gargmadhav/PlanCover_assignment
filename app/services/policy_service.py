...
from app.ingestion.document_processor import DocumentIngestor
from app.extraction.extraction_pipeline import PolicyExtractionPipeline
from app.schemas.response import QMSPolicyOutput
from app.utils.file_utils import save_temp_file, cleanup_temp_file
from app.utils.json_utils import dumps_json
from app.utils.logging import logger

OUTPUT_DIR = os.path.abspath(os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(__file__))), "outputs"))
...
class PolicyService:
    ...
    def _save_qms_json(self, output: QMSPolicyOutput, original_filename: str):
        """Automatically persists extracted QMS JSON into dedicated outputs folder."""
        try:
